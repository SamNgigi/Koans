...
class AboutStrings(Koan):
    ...
    def test_double_quoted_strings_are_strings(self):
        string = "Hello, world."
        """ 
            This is dope. isinstance(string, str) returns a boolean that
            checks if the first arg is an instance of the second arg.

            Therefore the assertEqual method required a boolean. In this
            case True.
        """
    ...
    def test_use_backslash_for_escaping_quotes_in_strings(self):
        """
        In using backslash for escaping we escape the character that
        comes immediately after the quotes. 
        """
        a = "He said, \"Don't\""
        b = 'He said, "Don\'t"'
...
world!
"""
        self.assertEqual(len(string), len(string)) # or we could say 15
    ...
    def test_adjacent_strings_are_concatenated_automatically(self):
        """
            Did not know this works. But doesn't seem practical if you
            cannot use it with variables. 
        """
        string = "Hello" ", " "world"
        self.assertEqual("Hello, world", string)
